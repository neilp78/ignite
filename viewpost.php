...
$stmt = $db->prepare('SELECT postID, postTitle, postCont, postSlug, postDesc, postDate FROM blog_posts_seo WHERE postSlug = :postSlug');
...
<head>
  ...
  <link rel="apple-touch-icon" href="/assets/images/govuk-apple-touch-icon.png">
	...
	<link rel="stylesheet" href="admin/ds/gds/css/gds-css.css">
...
<body class="govuk-template__body ">
  ...
  <script src="admin/theme/govuk-frontend.js"></script>
	<script>
		$( document ).ready(function() {
	    sessionStorage.clear();
		});
		$('textarea, select').removeAttr('disabled');
		$('p, dd, li, dt, span, td, th, h1, h2, h3, h4').each(function(){
			if($(this).is(':contains("[[[")')) {
		...
		$('input').each(function(){
		  if (!$(this).attr("data-conditional-data") == "") {
		    ...
		    $(this).change(function() {
		      $('.govuk-button').attr('href',conditionSet);
